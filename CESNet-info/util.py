...
class PreloadedEventGenerator(Dataset):
    def __init__(self, datapath, min_mag, limit, stations_table, stations_channel_boolean, stations_channel_class, latlon_IDtable,
        ...
        self.event_metadata, self.trace_filename, self.survival_table = self.load_events(datapath, min_mag, limit, first_appearance_list, last_appearance_list)
    ...
    def __getitem__(self, index): 
        ...
        batch_pga_times = data['pga_times']
        batch_pga = data['pga']
        batch_pgv = data['pgv'] 
        ...
        for i, idx in enumerate(indexes):
            pga_times = batch_pga_times[i].copy()
    ...
    def load_events(self, data_paths, min_mag, limit, first_appearance_list, last_appearance_list):
        ...
        return event_metadata, trace_filename, survival_table
